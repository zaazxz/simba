                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ str_contains($url, 'index') ? 'active' : '' }}"
                                        href="{{ route('kelas.index') }}">Semua <span
                                            class="{{ str_contains($url, 'index') ? 'badge badge-white' : 'badge badge-primary' }}">{{ $kelas_all }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ str_contains($url, 'aktif') ? 'active' : '' }}"
                                        href="{{ route('kelas.aktif') }}">Aktif <span
                                            class="{{ str_contains($url, 'aktif') ? 'badge badge-white' : 'badge badge-primary' }}">{{ $kelas_aktif }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ str_contains($url, 'non') ? 'active' : '' }}"
                                        href="{{ route('kelas.non') }}">Pending <span
                                            class="{{ str_contains($url, 'non') ? 'badge badge-white' : 'badge badge-primary' }}">{{ $kelas_nonaktif }}</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn btn-warning btn-flat my-1" data-toggle="tooltip"
                                                            title='Edit'
                                                            href="{{ route('kelas.edit', $class->id ?? 'test') }}">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a class="btn btn btn-danger btn-flat my-1" data-toggle="tooltip"
                                                            title='Delete'
                                                            href="{{ route('kelas.destroy', $class->id ?? 'test') }}">
