...
@section('title', 'Input Baru Data Kelas')
@section('content')
    @php
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Input Kelas Baru</div>
                </div>
            </div>
            <div class="section-body">
                <h2 class="section-title">Input Kelas Baru</h2>
                <p class="section-lead">
                    Di halaman ini, Anda dapat menambahkan Data Kelas baru.
                </p>
