...
@section('title','Input Baru Data User')
@section ('content')
@php
...
<div class="main-content" style="min-height: 524px;">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Input User Baru</h2>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2">Nama Lengkap</label>
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2">Unit Induk</label>
                        <div class="col-sm-12 col-md-4">
